...
class _AddressScreenState extends State<AddressScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    List<District> districts = _addressModel.province == null ? [] : _addressModel.province.districts.values.toList();
    districts.sort(compareDistricts);

    List<Ward> wards = _addressModel.district == null ? [] : _addressModel.district.wards.values.toList();
        ...
        child: Column(
          children: [
            Card(
              ...
              child: ListTile(
                onTap: () {
                  Navigator.pop(context, AccessInfo().userInfo.address);
                },
                ...
                subtitle: Text(
                  AccessInfo().userInfo.address.toString(),
                  ...
                  child: Column(
                    ...
                    children: [
                      TextFormField(
                        ...
                        decoration:
                            InputDecoration(hintText: S.of(context).addressHint, labelText: S.of(context).address),
                      ),
                      SizedBox(height: 10),
                      DropdownButtonFormField<Province>(
                        ...
                        items: provinces
                            .map<DropdownMenuItem<Province>>((province) => DropdownMenuItem<Province>(
                                  value: province,
                      ...
                      DropdownButtonFormField<District>(
                        ...
                        items: districts
                            .map<DropdownMenuItem<District>>((district) => DropdownMenuItem<District>(
                                  value: district,
                      ...
                      DropdownButtonFormField<Ward>(
                        ...
                        items: wards
                            .map<DropdownMenuItem<Ward>>((ward) => DropdownMenuItem<Ward>(
                                  value: ward,
