...
class _InvitationScreenState extends State<InvitationScreen> {
  ...
  List<Invitation> _processedInvitations = [];
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              TimeAgo.parse(invitation.invitationTime, locale: Localizations.localeOf(context).languageCode),
                                      ...
                                      GroupServices.declineInvitation(invitation.groupId).then((value) {
                                        if (value) {
                                          setState(() {
                                            ...
                                            _processedInvitations.add(invitation);
                                          });
                                        }
                                      });
                                    },
